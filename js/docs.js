var docs = {
  ...
  'ввести дані': {
    'uk': '<p>Пссс... А можливо це input()?</p>'
  },
  'вивести': {
    'uk': '<p>Хммм...Здається це може бути або print , або return.</p>'
  },
  'цикл': {
    'uk': '<p>Ми використовуємо цикл в тих випадках, коли нам потрібно повторити щось n-ну кількість разів. Наприклад, є цикли <strong>for</strong> чи <strong>while </strong> . Пам\'ятаєте, яка між ними різниця?</p>'
  }
};
